...
public class ProfesorService {
    ...
    public java.util.List<Profesor> consultarTodosCriteria() {
        System.out.println("Consulta a todos con Criteria API:");
        return this.profesorRepository.seleccionarTodosCriteria();
    }

    public java.util.List<Profesor> consultarPorNombreCriteria(String nombre){
    ...
    public java.util.List<Profesor> consultarDinamico(String nombre, String apellido){
        System.out.println("Consulta dinamica con Criteria API: " + nombre + " " + apellido);
        return this.profesorRepository.seleccionarDinamico(nombre, apellido);
    }
}

...
public class Main {
    ...
    public static class App implements QuarkusApplication {
        ...
        // Inyectamos el Service (Arquitectura Taller 17/18)
        @Inject
        ...
        public int run(String... args) {
            ...
            // --- INSERCIÓN DE DATOS ORIGINALES (TAREA 7) ---
            ...
            p1.setFechaDocencia(LocalDate.of(1979, 3, 14)); // Nuevo campo
            ...
            Profesor profeCedula = this.profesorService.consultarPorCedula("2222222222");
            System.out.println("Buscando cédula '2222222222' -> Encontrado: " + profeCedula.getNombre() + " " + profeCedula.getApellido());

            System.out.println("Por Apellido (Ruiz):");
            this.profesorService.consultarPorApellido("Ruiz"); 
            ...
            Profesor profeCedulaNative = this.profesorService.consultarPorCedulaNative("1111111111");
            System.out.println("Encontrado por cédula (1111111111): " + profeCedulaNative.getNombre());
